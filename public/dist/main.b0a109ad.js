...
function (_super) {
  ...
  MenuScene.prototype.create = function () {
    ...
    var optionsButton = this.add.image(this.game.renderer.width / 2, this.game.renderer.height / 2 + 50, 'options').setDepth(1);
    var pvpButton = this.add.image(this.game.renderer.width / 2, this.game.renderer.height / 2 + 100, 'pvp').setDepth(1); //create hover sprite near play button
    ...
    */
    ...
    pvpButton.on("pointerover", function () {
      hoverSprite.setVisible(true);
      hoverSprite.x = pvpButton.x - 140;
      hoverSprite.y = pvpButton.y;
    });
    pvpButton.on("pointerout", function () {
      hoverSprite.setVisible(false);
    });
    pvpButton.on("pointerup", function () {
      _this.scene.start(CST_1.CST.SCENES.PVP);
    });
  };
...
},{"../CST":"src/CST.ts"}],"src/prefabs/Bullet.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  Bullet.prototype.fire = function (shooter, target) {
    ...
    this.direction = Math.atan((target.x - this.x) / (target.y - this.y)); //some light randomness to the bullet angle
...
/** @class */
function (_super) {
  __extends(PVPBullet, _super);

  function PVPBullet(scene, x, y) {
    var _this = _super.call(this, scene, x, y, 'bullet') || this;
  ...
  PVPBullet.prototype.fire = function (shooter, target) {
    this.setPosition(shooter.x, shooter.y); // Initial position
  ...
  PVPBullet.prototype.update = function (time, delta) {
    this.x += this.xSpeed * delta;
    this.y += this.ySpeed * delta;
    this.born += delta;
...
},{"ms":"../node_modules/socket.io-client/node_modules/ms/index.js"}],"C:/Users/Alex/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"./common":"../node_modules/socket.io-client/node_modules/debug/src/common.js","process":"C:/Users/Alex/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../node_modules/socket.io-client/lib/url.js":[function(require,module,exports) {
...
},{"./debug":"../node_modules/socket.io-client/node_modules/socket.io-parser/node_modules/debug/src/debug.js","process":"C:/Users/Alex/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../node_modules/component-emitter/index.js":[function(require,module,exports) {
...
},{}],"C:/Users/Alex/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{}],"C:/Users/Alex/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/ieee754/index.js":[function(require,module,exports) {
...
},{}],"C:/Users/Alex/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/isarray/index.js":[function(require,module,exports) {
var toString = {}.toString;
...
},{}],"C:/Users/Alex/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js":[function(require,module,exports) {
...
},{"base64-js":"C:/Users/Alex/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/base64-js/index.js","ieee754":"C:/Users/Alex/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/ieee754/index.js","isarray":"C:/Users/Alex/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/isarray/index.js","buffer":"C:/Users/Alex/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"../node_modules/socket.io-client/node_modules/socket.io-parser/is-buffer.js":[function(require,module,exports) {
...
},{"buffer":"C:/Users/Alex/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"../node_modules/socket.io-client/node_modules/socket.io-parser/binary.js":[function(require,module,exports) {
/*global Blob,File*/
...
},{"isarray":"../node_modules/isarray/index.js","buffer":"C:/Users/Alex/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"../node_modules/arraybuffer.slice/index.js":[function(require,module,exports) {
/**
...
},{"./common":"../node_modules/engine.io-client/node_modules/debug/src/common.js","process":"C:/Users/Alex/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../node_modules/engine.io-client/lib/transports/polling.js":[function(require,module,exports) {
/**
 * Module dependencies.
 */
...
},{"./polling":"../node_modules/engine.io-client/lib/transports/polling.js","component-inherit":"../node_modules/component-inherit/index.js"}],"C:/Users/Alex/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/_empty.js":[function(require,module,exports) {
...
},{"./url":"../node_modules/socket.io-client/lib/url.js","socket.io-parser":"../node_modules/socket.io-client/node_modules/socket.io-parser/index.js","./manager":"../node_modules/socket.io-client/lib/manager.js","debug":"../node_modules/socket.io-client/node_modules/debug/src/browser.js","./socket":"../node_modules/socket.io-client/lib/socket.js"}],"src/scenes/PVPScene.ts":[function(require,module,exports) {
"use strict";
...
var PVPBullets_1 = require("../prefabs/PVPBullets");
...
/** @class */
function (_super) {
  __extends(PVPScene, _super);

  function PVPScene() {
    var _this = _super.call(this, {
      key: CST_1.CST.SCENES.PVP
    }) || this;
  ...
  PVPScene.prototype.create = function () {
    var _this = this;
    ...
    this.playerBullets = this.physics.add.group({
      classType: PVPBullets_1.PVPBullet,
      maxSize: 50,
      runChildUpdate: true
    });
    ...
    this.socket.on('currentPlayers', function (players) {
      ...
      Object.keys(players).forEach(function (id) {
        if (players[id].playerId === _this.socket.id) {
          _this.createPlayer(players[id]);
        } else {
          _this.createOtherPlayer(players[id]);
        }
      });
    });
    this.socket.on('newPlayer', function (playerInfo) {
      ...
      _this.createOtherPlayer(playerInfo);
    });
    this.socket.on('disconnect', function (playerId) {
      _this.otherPlayers.forEach(function (otherPlayer) {
    ...
    this.socket.on('playerShot', function (playerInfo) {
      _this.otherPlayers.forEach(function (otherPlayer) {
        if (playerInfo.playerId === otherPlayer.playerId) {
          _this.otherFiredBullet = _this.otherPlayerBullets.get();

          if (_this.otherFiredBullet) {
            _this.otherFiredBullet.setActive(true).setVisible(true);

            var velocity = new Phaser.Math.Vector2();

            _this.physics.velocityFromRotation(playerInfo.rotation, 400, velocity);

            _this.otherFiredBullet.fire(otherPlayer.player, {
              x: velocity.x * 180 / Math.PI,
              y: velocity.y * 180 / Math.PI
            });

            console.log(_this.physics.overlap(_this.player, _this.otherFiredBullet));

            if (_this.physics.overlap(_this.player, _this.otherFiredBullet)) {
              console.log("hit");
            }
          }
        }
    ...
    this.input.on('pointerdown', function () {
      _this.playerFiredBullet = _this.playerBullets.get();

      if (_this.playerFiredBullet) {
        _this.playerFiredBullet.setActive(true).setVisible(true);

        var velocity = new Phaser.Math.Vector2();

        _this.physics.velocityFromRotation(_this.player.rotation, 400, velocity);

        _this.playerFiredBullet.fire(_this.player, {
          x: velocity.x * 180 / Math.PI,
          y: velocity.y * 180 / Math.PI
        });

        _this.socket.emit('playerShoot', {
          x: _this.player.x,
          y: _this.player.y,
          rotation: _this.player.rotation
        });
      }
    }, this);
  };

  PVPScene.prototype.createPlayer = function (playerInfo) {
    this.player = this.physics.add.sprite(playerInfo.x, playerInfo.y, "player");
    this.player.setCollideWorldBounds(true);
  };

  PVPScene.prototype.createOtherPlayer = function (playerInfo) {
  ...
  PVPScene.prototype.update = function () {
    if (this.player) {
      this.player.setVelocity(0);
